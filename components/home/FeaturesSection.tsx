...
const FEATURES: { Icon: FeatureIcon; title: string; desc: string; color: string; iconBg: string; iconColor: string }[] = [
  { Icon: EyeOff,        title: "Stealth Overlay",        desc: "Invisible to screen-share on Zoom, Teams, Meet. Your secret weapon during real interviews.",                    color: "bg-indigo-50 border-indigo-100",   iconBg: "bg-indigo-500",   iconColor: "text-white" },
  ...
  { Icon: Zap,           title: "Sub-2-Second Speed",      desc: "Groq LPU inference streams the perfect answer before you even finish thinking about it.",                      color: "bg-amber-50 border-amber-100",     iconBg: "bg-amber-500",    iconColor: "text-white" },
