...
const STEPS = [
  {
    ...
    tip: "Include specific metrics in your resume (e.g. 'reduced latency by 40%') — CoopilotX will reference them in answers.",
  },
  {
    n: "02",
    color: "bg-violet-600",
  ...
  },
  {
    ...
    desc: "Your interviewer asks a question. CoopilotX picks it up via your microphone, transcribes it in real time, matches it against your resume context, and streams a tailored answer to your private overlay — all in under 2 seconds. You read it naturally, in your own words.",
    detail: [
