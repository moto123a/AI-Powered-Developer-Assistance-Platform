...
const ALL_PLANS: {
...
}[] = [
  {
    ...
    features: [
      ...
      "Mock interview sessions for your exact role",
  ...
  },
  {
    ...
    usagePool: "Unlimited",
    features: [
      "Unlimited use, no credits ever",
      "Desktop app, completely invisible on screen share",
      "Camera stealth, hidden even physically",
  ...
  },
  {
    ...
    popular: false,
    special: "teams",
    usagePool: "Unlimited per seat",
    features: [
      "5 full Pro seats included",
      "$9.80 per user per month",
      "One invoice, one account for all 5",
      "Unlimited access for every user",
...
const ROWS: { cat: string; label: string; free: boolean | string; pro: boolean | string; lifetime: boolean | string; teams: boolean | string }[] = [
  ...
  { cat: "Live Copilot",  label: "Monthly allowance",                    free: "50 min/mo",    pro: "Unlimited",   lifetime: "Unlimited",  teams: "Unlimited"  },
  ...
  { cat: "Mock Practice", label: "Mock interview sessions",              free: "6/month",      pro: "Unlimited",   lifetime: "Unlimited",  teams: "Unlimited"  },
  ...
  { cat: "Billing",       label: "Credits",                              free: "100/mo",       pro: "No credits",  lifetime: "No credits", teams: "No credits" },
...
const FAQS = [
  ...
  {
    q: "What are credits?",
    a: "Credits are a simple usage meter for the Starter plan. Live copilot costs 2 credits per minute. A mock session costs 15 credits. Starter gives you 100 credits every month, which resets on your billing date. Pro, Lifetime, and Teams skip credits entirely.",
  },
  {
